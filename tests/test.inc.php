...
if(!file_exists(dirname(__FILE__).'/dao'))
{
	...
	$generator = new Parm\Generator\DatabaseGenerator(\Parm\ParmConfig::getDatabase('parm_namespaced_tests'));
	$generator->setDestinationDirectory(dirname(__FILE__).'/dao/namespaced');
	$generator->setGeneratedNamespace("ParmTests\\Dao");
	$generator->generate();

	$generator = new Parm\Generator\DatabaseGenerator(\Parm\ParmConfig::getDatabase('parm-global-tests'));
